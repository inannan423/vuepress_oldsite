...
<h1 class="npm">npm update Jetzihan@2.0</h1>
...
.npm:hover{
  color: LightPink;
  border-right: .1em solid  LightPink;
}
.main{
  height:20vh;
  width:100%;  
...
你好！*欢迎来到我的Coding飞行器*。来自热爱前端设计和开发的数媒程序猿一只(</>)。我把网站从vue.js原生迁移到这里来了，一是因为实在是没有时间造轮子，二是因为vuepress天然支持markdown管理的魅力。接触到Markdown 的时候，我就被它简洁干净的语法深深吸引，markdown以其“所写即所得”的特性，受全球程序员的热爱，因此，大多数的技术文档都由markdown写成，它的代码块和兼容html标签的能力更是便捷。**使用vuepress的语法及其主题，并配套GithubPages网站托管和GithubActions持续集成，很快你就能搭建一个属于自己的博客站，这是我迁移的最大原因。**
:::
...
<div class="nop">Front-end Magician</div>
